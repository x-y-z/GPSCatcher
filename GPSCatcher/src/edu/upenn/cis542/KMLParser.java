/*
 * KML parser, which is used in navigation part
 * 
 * Code is modifed from:
...
public class KMLParser extends DefaultHandler {
	...
	private Routing navigationDataSet = new Routing();

	// ===========================================================
	// Getter & Setter
	// ===========================================================

	public Routing getParsedData() {
	...
	public void startDocument() throws SAXException {
		this.navigationDataSet = new Routing();
	}
